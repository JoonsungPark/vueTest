    ...
    <header>
          ...
          <div class="row">
            <div class="col-sm-4 py-4">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <router-link to="/login" class="text-white" v-if="!$store.state.isAuthenticated">로그인</router-link>
      ...
      <div class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container">
          ...
          <router-link to="/cart" class="cart btn" v-if="$store.state.isAuthenticated">
